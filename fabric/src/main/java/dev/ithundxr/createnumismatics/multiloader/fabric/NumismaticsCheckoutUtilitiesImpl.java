...
public class NumismaticsCheckoutUtilitiesImpl extends NumismaticsCheckoutUtilities {
    ...
    */
    public static boolean finishShopInteractionStock(
        ...
        for (StorageView<ItemVariant> slot : tickerBE.getReceivedPaymentsHandler()) {
        ...
        for (boolean simulate : Iterate.trueAndFalse) {
            ...
            toTransfer.forEach(s -> TransferUtil.insertItem(tickerBE.getReceivedPaymentsHandler(), s));
        }
