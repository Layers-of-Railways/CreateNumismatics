...
public abstract class EnergySalepointTargetBehaviour extends SalepointTargetBehaviour<Energy> {

    public EnergySalepointTargetBehaviour(SmartBlockEntity be) {
        super(be);
    }

    @Override
    protected @Nullable ISalepointState<?> tryBindToSalepointInternal() {
        return SalepointTypes.ENERGY.create();
    }

    @Override
    protected @NotNull Class<Energy> getContentType() {
        return Energy.class;
    }
}
