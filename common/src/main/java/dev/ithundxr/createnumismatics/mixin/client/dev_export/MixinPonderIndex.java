...
public class MixinPonderIndex {
    @ModifyReturnValue(method = "editingModeActive", at = @At("RETURN"), remap = false)
    private static boolean noEditingInExport(boolean original) {
        return original && !PonderExport.active;
    }
}
