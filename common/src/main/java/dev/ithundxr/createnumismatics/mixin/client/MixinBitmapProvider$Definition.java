...
public class MixinBitmapProvider$Definition {
    ...
    private int numismatics$monospaceCoins(BitmapProvider.Definition instance, NativeImage image, int width, int height, int x, int y, Operation<Integer> original) {
